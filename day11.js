...
//question1
 let [e , pi, gravity, bodyTemperature ,boilingPoint] = constants
 console.log(e ,pi,gravity,bodyTemperature,boilingPoint)
 //q 2
...
const countryData = []
for ({name,capital,population,languages}of countriesWorld){
  countryData.push({name : name ,population :population , languages :languages , capital :capital})
}
console.log(countryData)

//q 2
// A junior developer structure student name, skills and score in array of
// arrays which may not be easy to read. Destructure the following array name 
//to name, skills array to skills, scores array to 
//scores, JavaScript score to jsScore and React score to reactScore variable in one line.
/* const student = ['David', ['HTM', 'CSS', 'JS', 'React'], [98, 85, 90, 95]]
let [named,skills, score] = student
console.log(named)
console.log(skills)
console.log(score)
let [,,jsScore, reactScore] = StudentScores
console.log(named, skills, studentScores, jsScore, reactScore)*/
const student = ['David', ['HTM', 'CSS', 'JS', 'React'], [98, 85, 90, 95]]
let [named,skills,scores] = student
console.log(named)
let [,,jsScore,reactScore] = scores
console.log(named, skills, scores, jsScore, reactScore)
...
// Write a function called convertArrayToObject which can convert the array to a structure object.
 convertArrayToObject = (students ) =>{
   ...
   for(const[name, skills,scores] of students){
     studentObject.push({name :name , skills : skills , scores :scores})
...
const copyStudent = JSON.parse(JSON.stringify(studentCopy));
